...
const ConvertPB = () => {
  ...
  const convertPetabytes = () => {
    ...
    let inputToBits = parseFloat(inputToConvert.value) * 1024 * 1024 * 1024 * 1024 * 1024 * 1024;
    document.querySelector('#bits').setAttribute('value', separator(inputToBits) + ' Bits');

    let inputToB = parseFloat(inputToConvert.value) * 1024 * 1024 * 1024 * 1024 * 1024;
    document.querySelector('#bytes').setAttribute('value', separator(inputToB) + ' B');

    let inputToKB = parseFloat(inputToConvert.value) * 1024 * 1024 * 1024 * 1024;
    document
